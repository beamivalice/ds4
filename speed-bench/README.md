...
# Leave-one-out from full (disable one feature)
DS4_METAL_DISABLE_PREFILL_MOE_WIDE_TILES=1 ./ds4-bench -m MODEL ...
DS4_METAL_DISABLE_MOE_GATE_UP_PAIR=1 ./ds4-bench -m MODEL ...
DS4_METAL_DISABLE_PREFILL_FLASH_NWG64=1 ./ds4-bench -m MODEL ...
```
